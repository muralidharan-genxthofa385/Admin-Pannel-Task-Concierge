...
import type { CSSProperties } from 'react'; // for mixBlendMode type
...
interface LightPillarProps {
  ...
  mixBlendMode?: CSSProperties['mixBlendMode']; // Correct type for mix-blend-mode
...
const LightPillar = ({
  ...
  const rafRef = useRef<number | null>(null); // number is fine for requestAnimationFrame in browser
  ...
  useEffect(() => {
    ...
    // Device detection for quality fallback
    ...
    // Mouse interaction
    let mouseMoveTimeout: number | null = null; // Use number for browser setTimeout
    const handleMouseMove = (event: MouseEvent) => {
      ...
      }, 16) as any; // Type assertion for browser compatibility
